...
(22,'Isabel','Allende');
SET IDENTITY_INSERT autore OFF;

--- INSERIMENTO EDITORI ---
SET IDENTITY_INSERT editore ON;
...
SET IDENTITY_INSERT editore OFF;

--- INSERIMENTO LIBRI ---
SET IDENTITY_INSERT libro ON;
INSERT INTO libro (id, titolo, prezzo, pagine, editore_id) VALUES 
(1,'Alchimista (L'')',12.00,184,10), -- Corretto ordine: ID, Titolo, Prezzo, Pagine, Editore
...
SET IDENTITY_INSERT autore_libro ON;
...
SET IDENTITY_INSERT autore_libro OFF;

-- Reset dei contatori per evitare errori nei prossimi inserimenti
DBCC CHECKIDENT ('autore', RESEED);
DBCC CHECKIDENT ('editore', RESEED);
DBCC CHECKIDENT ('libro', RESEED);
DBCC CHECKIDENT ('autore_libro', RESEED);
