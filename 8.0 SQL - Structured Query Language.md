...
## Addizione e Sottrazione
    ...
    #Utilizzando il comando SELECT possiamo aggiungere campi alla nostra
    query che rappresentano calcoli algebrici di base su un campo esistente.
    Nell'esempio che segue la query restituirà il prezzo corrente e il prezzo
    con il 10% in più.
